...
{
  new (message_memory) trident_msgs::msg::Waypoint(_init);
}

void Waypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<trident_msgs::msg::Waypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoint_message_member_array[2] = {
  {
    ...
    offsetof(trident_msgs::msg::Waypoint, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<trident_msgs::msg::WaypointAction>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(trident_msgs::msg::Waypoint, action),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoint_message_members = {
  ...
  2,  // number of fields
  sizeof(trident_msgs::msg::Waypoint),
...
{
  return &::trident_msgs::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
