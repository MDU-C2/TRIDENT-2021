  ...
  void * untyped_ros_message)
{
  ...
  // Field name: setpoints
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->setpoints, size)) {
      return "failed to create array for field 'setpoints'";
    }
    auto array_ptr = ros_message->setpoints.data;
...
static size_t _Setpoints__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_cola2_msgs__msg__Setpoints(
    full_bounded, 0);
}
