...
#include "trident_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const trident_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trident_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &trident_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
