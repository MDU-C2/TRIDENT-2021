...
#include "trident_msgs/msg/detail/waypoint_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const trident_msgs::msg::WaypointAction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  trident_msgs::msg::WaypointAction & ros_message)
{
  // Member: action_type
  cdr >> ros_message.action_type;
...
{
  auto typed_message =
    static_cast<const trident_msgs::msg::WaypointAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trident_msgs::msg::WaypointAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WaypointAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const trident_msgs::msg::WaypointAction *>(
...
{
  return max_serialized_size_WaypointAction(full_bounded, 0);
}

static message_type_support_callbacks_t _WaypointAction__callbacks = {
  "trident_msgs::msg",
  "WaypointAction",
...
static rosidl_message_type_support_t _WaypointAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WaypointAction__callbacks,
...
{
  return &trident_msgs::msg::typesupport_fastrtps_cpp::_WaypointAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, msg, WaypointAction)() {
  return &trident_msgs::msg::typesupport_fastrtps_cpp::_WaypointAction__handle;
}
