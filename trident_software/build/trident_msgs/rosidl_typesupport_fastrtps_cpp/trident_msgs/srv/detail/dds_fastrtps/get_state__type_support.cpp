...
#include "trident_msgs/srv/detail/get_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const trident_msgs::srv::GetState_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  trident_msgs::srv::GetState_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const trident_msgs::srv::GetState_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trident_msgs::srv::GetState_Request *>(
    untyped_ros_message);
...
{
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, GetState_Request)() {
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trident_msgs
cdr_serialize(
  const trident_msgs::srv::GetState_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  trident_msgs::srv::GetState_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  // Member: int_state
  {
    size_t item_size = sizeof(ros_message.int_state);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const trident_msgs::srv::GetState_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<trident_msgs::srv::GetState_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, GetState_Response)() {
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState_Response__handle;
}
...
{
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, GetState)() {
  return &trident_msgs::srv::typesupport_fastrtps_cpp::_GetState__handle;
}
