...
class Metaclass_GetState_Response(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        # as well as populate each message instance
        return {
            'INT_STATE__DEFAULT': -1,
        }

    @property
    def INT_STATE__DEFAULT(cls):
        """Return default value for message field 'int_state'."""
        return -1
...
class GetState_Response(metaclass=Metaclass_GetState_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.int_state = kwargs.get(
            'int_state', GetState_Response.INT_STATE__DEFAULT)
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.int_state != other.int_state:
            return False
        return True
    ...
    @property
    def int_state(self):
        """Message field 'int_state'."""
        return self._int_state

    @int_state.setter
    def int_state(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'int_state' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'int_state' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._int_state = value
...
class Metaclass_GetState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from trident_msgs.srv import _get_state
...
class GetState(metaclass=Metaclass_GetState):
    from trident_msgs.srv._get_state import GetState_Request as Request
    from trident_msgs.srv._get_state import GetState_Response as Response
