...
class Mission(metaclass=Metaclass_Mission):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<trident_msgs/Waypoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['trident_msgs', 'msg'], 'Waypoint')),  # noqa: E501
    )
