...
class Metaclass_Waypoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from trident_msgs.msg import WaypointAction
            if WaypointAction.__class__._TYPE_SUPPORT is None:
                WaypointAction.__class__.__import_type_support__()
...
class Waypoint(metaclass=Metaclass_Waypoint):
    ...
    _fields_and_field_types = {
        ...
        'action': 'trident_msgs/WaypointAction',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['trident_msgs', 'msg'], 'WaypointAction'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from trident_msgs.msg import WaypointAction
        self.action = kwargs.get('action', WaypointAction())
    ...
    def action(self, value):
        if __debug__:
            from trident_msgs.msg import WaypointAction
            assert \
                isinstance(value, WaypointAction), \
                "The 'action' field must be a sub message of type 'WaypointAction'"
        self._action = value
