...
bool trident_msgs__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trident_msgs.msg._waypoint.Waypoint", full_classname_dest, 35) == 0);
  }
  trident_msgs__msg__Waypoint * ros_message = _ros_message;
  {  // pose
  ...
  {  // action
    ...
    if (!trident_msgs__msg__waypoint_action__convert_from_py(field, &ros_message->action)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * trident_msgs__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("trident_msgs.msg._waypoint");
  ...
  {  // action
    PyObject * field = NULL;
    field = trident_msgs__msg__waypoint_action__convert_to_py(&ros_message->action);
    if (!field) {
      return NULL;
    }
    {
