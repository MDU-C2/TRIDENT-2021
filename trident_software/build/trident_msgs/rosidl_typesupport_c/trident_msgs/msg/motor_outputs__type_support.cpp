...
static const _MotorOutputs_type_support_symbol_names_t _MotorOutputs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trident_msgs, msg, MotorOutputs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trident_msgs, msg, MotorOutputs)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trident_msgs, msg, MotorOutputs)() {
  return &::trident_msgs::msg::rosidl_typesupport_c::MotorOutputs_message_type_support_handle;
}
