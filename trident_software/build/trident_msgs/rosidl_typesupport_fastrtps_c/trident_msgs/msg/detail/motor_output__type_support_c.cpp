...
#include "trident_msgs/msg/detail/motor_output__rosidl_typesupport_fastrtps_c.h"
...
using _MotorOutput__ros_msg_type = trident_msgs__msg__MotorOutput;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorOutput__ros_msg_type * ros_message = static_cast<const _MotorOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MotorOutput__ros_msg_type * ros_message = static_cast<_MotorOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _MotorOutput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_trident_msgs__msg__MotorOutput(
...
{
  return max_serialized_size_trident_msgs__msg__MotorOutput(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MotorOutput = {
  "trident_msgs::msg",
  "MotorOutput",
...
static rosidl_message_type_support_t _MotorOutput__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorOutput,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trident_msgs, msg, MotorOutput)() {
  return &_MotorOutput__type_support;
}
