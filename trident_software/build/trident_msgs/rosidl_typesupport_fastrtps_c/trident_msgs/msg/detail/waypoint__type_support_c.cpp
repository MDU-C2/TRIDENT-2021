...
#include "trident_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "trident_msgs/msg/detail/waypoint_action__functions.h"  // action
...
using _Waypoint__ros_msg_type = trident_msgs__msg__Waypoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: action
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, trident_msgs, msg, WaypointAction
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_trident_msgs__msg__WaypointAction(
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_trident_msgs__msg__Waypoint(
  ...
  size_t current_alignment)
{
  ...
  // member: action
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_trident_msgs__msg__WaypointAction(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_trident_msgs__msg__Waypoint(
    full_bounded, 0);
}
