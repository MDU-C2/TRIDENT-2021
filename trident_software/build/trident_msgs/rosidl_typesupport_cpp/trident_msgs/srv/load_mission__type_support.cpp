...
static const _LoadMission_Request_type_support_symbol_names_t _LoadMission_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, LoadMission_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, trident_msgs, srv, LoadMission_Request)),
  }
};
...
{
  return &::trident_msgs::srv::rosidl_typesupport_cpp::LoadMission_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, trident_msgs, srv, LoadMission_Request)() {
  return get_message_type_support_handle<trident_msgs::srv::LoadMission_Request>();
}
...
static const _LoadMission_Response_type_support_symbol_names_t _LoadMission_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, LoadMission_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, trident_msgs, srv, LoadMission_Response)),
  }
};
...
{
  return &::trident_msgs::srv::rosidl_typesupport_cpp::LoadMission_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, trident_msgs, srv, LoadMission_Response)() {
  return get_message_type_support_handle<trident_msgs::srv::LoadMission_Response>();
}
...
static const _LoadMission_type_support_symbol_names_t _LoadMission_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trident_msgs, srv, LoadMission)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, trident_msgs, srv, LoadMission)),
  }
};
...
{
  return &::trident_msgs::srv::rosidl_typesupport_cpp::LoadMission_service_type_support_handle;
}
