...
#ifndef TRIDENT_MSGS__SRV__DETAIL__GET_GOAL_POSE__FUNCTIONS_H_
#define TRIDENT_MSGS__SRV__DETAIL__GET_GOAL_POSE__FUNCTIONS_H_
...
/// Initialize srv/GetGoalPose message.
/**
...
/// Finalize srv/GetGoalPose message.
/**
...
/// Create srv/GetGoalPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trident_msgs__srv__GetGoalPose_Request__init().
...
/// Destroy srv/GetGoalPose message.
/**
 * It calls
 * trident_msgs__srv__GetGoalPose_Request__fini()
...
/// Initialize array of srv/GetGoalPose messages.
/**
...
/// Finalize array of srv/GetGoalPose messages.
/**
 * It calls
 * trident_msgs__srv__GetGoalPose_Request__fini()
...
/// Create array of srv/GetGoalPose messages.
/**
 * It allocates the memory for the array and calls
 * trident_msgs__srv__GetGoalPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetGoalPose messages.
/**
 * It calls
 * trident_msgs__srv__GetGoalPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trident_msgs__srv__GetGoalPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It calls
 * trident_msgs__srv__GetGoalPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It allocates the memory for the array and calls
 * trident_msgs__srv__GetGoalPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It calls
 * trident_msgs__srv__GetGoalPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRIDENT_MSGS__SRV__DETAIL__GET_GOAL_POSE__FUNCTIONS_H_
