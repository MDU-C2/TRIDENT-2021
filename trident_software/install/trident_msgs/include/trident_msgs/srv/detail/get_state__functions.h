...
#ifndef TRIDENT_MSGS__SRV__DETAIL__GET_STATE__FUNCTIONS_H_
#define TRIDENT_MSGS__SRV__DETAIL__GET_STATE__FUNCTIONS_H_
 ...
 * calls
 * trident_msgs__srv__GetState_Request__init().
...
/**
 * It calls
 * trident_msgs__srv__GetState_Request__fini()
 ...
 * trident_msgs__srv__GetState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * trident_msgs__srv__GetState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trident_msgs__srv__GetState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It calls
 * trident_msgs__srv__GetState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It allocates the memory for the array and calls
 * trident_msgs__srv__GetState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trident_msgs
...
/**
 * It calls
 * trident_msgs__srv__GetState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRIDENT_MSGS__SRV__DETAIL__GET_STATE__FUNCTIONS_H_
